...
- `fetch_crsp_daily()` — retrieves daily stock returns from CRSP via WRDS, filtered to common US equities, with market cap and CRSP-Compustat linking; supports optional permno subset and batch queries.
